...
| `ANTHROPIC_API_KEY env var is not set` | No API key in the process environment. | `export ANTHROPIC_API_KEY=sk-ant-...` or put it in your shell profile. Scriptorium does *not* read from the macOS Keychain yet. |
